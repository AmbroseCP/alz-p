...
param parHubNetworkingResourceGroupNamePrefix = 'rg-p-alz-conn'
param parDnsResourceGroupNamePrefix = 'rg-p-alz-dns'
param parDnsPrivateResolverResourceGroupNamePrefix = 'rg-p-alz-dnspr'
